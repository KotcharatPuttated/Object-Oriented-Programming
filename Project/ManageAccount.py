...
class Toplevel1:
    ...
    def __init__(self, top=None):
        ...
        self.Label1.place(relx=0.538, rely=0.114, height=150, width=150)
        ...
        self.Label2.place(relx=0.5, rely=0.0, height=72, width=196)
        ...
        self.Label2.configure(font="-family {Arial Rounded MT Bold} -size 36")
        ...
        self.Label5.place(relx=0.05, rely=0.222, height=29, width=143)
        ...
        self.Label5.configure(text='''Chanakan  Senee''')

        self.Label5_1 = tk.Label(self.Frame1)
        self.Label5_1.place(relx=0.427, rely=0.222, height=29, width=133)
        ...
        self.Label5_1.configure(text='''A64015024''')

        self.Button2 = tk.Button(self.Frame1)
        self.Button2.place(relx=0.798, rely=0.156, height=30, width=80)
        
        self.Button2.configure(background="#372a28")
        self.Button2.configure(compound='left')
        
        self.Button2.configure(font="-family {Comic Sans MS} -size 12")
        ...
        self.Button1.place(relx=0.069, rely=0.245, height=40, width=120)
        ...
        self.Button1.configure(text='''Product''')
        self.Button1.configure(command=self.open_add)

        self.Label3 = tk.Label(self.top)
        self.Label3.place(relx=0.288, rely=0.369, height=44, width=253)
        ...
        self.Label3.configure(text='''Manage Customer''')
        ...
        photo_location = targetpath+"iconaccount.png"
        global _img3
        ...
        self.Label6_1.place(relx=0.415, rely=0.218, height=32, width=126)
        ...
        self.Label6_1.configure(text='''Customer ID''')

        self.Label6_1_1 = tk.Label(self.Frame3)
        self.Label6_1_1.place(relx=0.066, rely=0.2, height=32, width=76)
        ...
        self.Label6_1_1.configure(text='''Name''')
